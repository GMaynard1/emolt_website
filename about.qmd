...
![](images/installation/1000004324.jpeg){width="100%"}
:::

::: .carousel-item
![](images/installation/IMG_20220622_155048304_HDR.jpg){width="100%"}
:::

::: {.carousel-item}
![](images/installation/unnamed.jpg){width="100%"}
:::
:::
...
[Mid-Coast and Southern ME, NH, and North Shore MA](tech_teams/sme.qmd){.btn .btn-success role="button"}

</div>

<div>

[South Shore MA, Cape Cod, and the Islands](tech_teams/ssci.qmd){.btn .btn-success role="button"}

[South Coast MA, RI, and CT](tech_teams/scri.qmd){.btn .btn-success role="button"}

[Mid-Atlantic](tech_teams/ma.qmd){.btn .btn-success role="button"}
</div>
::::::
